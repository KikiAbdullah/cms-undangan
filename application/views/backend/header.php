            ...
            <div class="navbar-brand">
                ...
                <a href="index.html">
                    ...
                    <span class="logo-text">
                        ...
                        <!-- Light Logo text -->
                        <img src="<?= base_url() ?>assets/admin/images/logo-light-text.png" class="light-logo" alt="homepage" />
                    </span>
                </a>
            </div>
            <!-- ============================================================== -->
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?= base_url() ?>assets/admin/images/users/profile-pic.jpg" alt="user" class="rounded-circle" width="40">
